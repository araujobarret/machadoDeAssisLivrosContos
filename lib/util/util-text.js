...
function getNextHeader (book, blockIndex, decreasing = false) {
  ...
  if (headerIndex != null) return headerIndex
  if (!headerIndex && decreasing) return 0
  if (!headerIndex && !decreasing) return book.src.blocks.length - 1
}
